...
#include <filesystem>
#include <chapter/depthTesting/Uniform.h>
...
int main()
{
    ...
    Shader shader("resources/shader/depthTesting/depthTesting.vert", "resources/shader/depthTesting/depthTesting.frag");

    shader.use().setInt(uniform.texture1(0));
