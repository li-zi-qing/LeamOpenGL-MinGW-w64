...
#include <filesystem>
#include <chapter/pointLight/Uniform.h>
...
int main()
{
    ...
    initInstance
        ...
        .setScreenHeight(600)
        .setScreenWidth(800)
        .setTitle("Light Casters | 投光物 | 点光源")
        .builder();
    GLFWwindow* window = initInstance.getWindow();

    Shader lightingShader("resources/shader/pointLight/pointLight.vert",
                          "resources/shader/pointLight/pointLight.frag");
    Shader lightCubeShader("resources/shader/pointLight/light_cube.vert",
                           "resources/shader/pointLight/light_cube.frag");
    ...
    lightingShader
        ...
        .setFloat(uniform.light.constant(1.0f))
        .setFloat(uniform.light.linear(0.09f))
        .setFloat(uniform.light.quadratic(0.032f))
        .setVec3(uniform.light.ambient(glm::vec3(0.2f, 0.2f, 0.2f)))
        .setVec3(uniform.light.diffuse(glm::vec3(0.5f, 0.5f, 0.5f)))
