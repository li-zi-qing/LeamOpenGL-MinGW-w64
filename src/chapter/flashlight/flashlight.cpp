...
#include <filesystem>
#include <chapter/flashlight/Uniform.h>
...
int main()
{
    ...
    initInstance
        ...
        .setScreenHeight(600)
        .setScreenWidth(800)
        .setTitle("Light Casters | 投光物 | 手电筒")
        .builder();
    GLFWwindow* window = initInstance.getWindow();

    Shader lightingShader("resources/shader/flashlight/flashlight.vert",
                          "resources/shader/flashlight/flashlight.frag");
    Shader lightCubeShader("resources/shader/flashlight/light_cube.vert",
                           "resources/shader/flashlight/light_cube.frag");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightingShader
            ...
            .setVec3(uniform.light.direction(camera.getFront()))
            .setFloat(uniform.light.cutOff(glm::cos(glm::radians(12.5f))))
            .setFloat(uniform.light.outerCutOff(glm::cos(glm::radians(17.5f))))
            .setVec3(uniform.light.position(camera.getPosition()))
            .setVec3(uniform.viewPos(camera.getPosition()));
